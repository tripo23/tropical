              ...
              <Container fluid className="containerCart bg-light">
                <Row className="align-items-center">
                  <Col xs={2} md={4} className="text-center">
                    {" "}
                    <Card.Subtitle className="text-muted small subheader">
                      {" "}
                      Producto{" "}
                    </Card.Subtitle>{" "}
                  </Col>
              ...
              <Container fluid className="containerCart">
                <Row className="align-items-center">
                  ...
                  <Col xs={3} className="text-center">
                    <Button
                      variant="outline-secondary btn-sm btn-cartEmpty"
                      onClick={ctxt.clear}
                    >
                      Vaciar carrito
                    </Button>{" "}
              ...
              <Card>
                ...
                <Card.Body>
                  ...
                  <Row className="pt-1">
                    ...
                    <Col sm={3}>
                      ${ctxt.calcSubTotal() + ctxt.shippingCost()}
                    </Col>
                  </Row>
                </Card.Body>
          ...
          <Container className="text-center w-75">
            <Row>
              {purchased ? (
                ...
                <p>
                  Tu carrito está vacío, tal vez quisieras ver qué tenemos para
                  ofrecerte...
                </p>
              )}
            </Row>
            <Row className="text-center justify-content-center">
              <Col md={7}>
                <Image
                  fluid
                  src={
                    "https://res.cloudinary.com/tripo23/image/upload/v1663449850/tropical/cart_empty2_ipdkmi.png"
                  }
                />
              </Col>
            </Row>
